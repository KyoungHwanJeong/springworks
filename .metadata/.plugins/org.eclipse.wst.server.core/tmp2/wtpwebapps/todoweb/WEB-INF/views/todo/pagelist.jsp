					...
					<div class="card-body">
						<h5 class="card-title">Todo 목록</h5>
							<form action="/todo/list_sort" method="get" class="list_sort">
								...
								<label>정렬: </label>
								<div>
								<input type="checkbox" name="sorts" value="recent"
								${pageRequestDTO.checkSort('recent') ? 'checked' : '' }>최신순
								<input type="checkbox" name="sorts" value="popular"
								${pageRequestDTO.checkSort('popular') ? 'checked' : '' }>제목순
								<button type="submit" class="btn btn-primary">Sort</button>
								</div>
								
								<select class="sort">
									<option type="text" name="sort" value="recent">최신순</option>
									<option type="text" name="sort" value="popular">제목순</option>
								</select>
